...
exports.imageUtils = exports.getImageDimensions = void 0;
/**
 ...
 */
const convertImageToWebPBase64 = async (image) => {
    try {
        ...
        const result = await imageToBase64(webP);
...
const isValidImageUrl = (url) => new Promise(resolve => {
    const img = new Image();
    img.src = url;
...
exports.imageUtils = {
    ...
    getImageDimensions: exports.getImageDimensions,
    isValidImageUrl
};
